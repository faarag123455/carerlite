 ...
 */
final class Version20260106231546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE applications DROP FOREIGN KEY `fk_app_candidate`');
        $this->addSql('ALTER TABLE applications DROP FOREIGN KEY `fk_app_job`');
        $this->addSql('ALTER TABLE applications DROP FOREIGN KEY `fk_app_resume`');
        $this->addSql('DROP INDEX idx_app_status ON applications');
        $this->addSql('ALTER TABLE applications DROP FOREIGN KEY `fk_app_candidate`');
        $this->addSql('ALTER TABLE applications DROP FOREIGN KEY `fk_app_job`');
        $this->addSql('ALTER TABLE applications DROP FOREIGN KEY `fk_app_resume`');
        ...
        $this->addSql('ALTER TABLE applications ADD CONSTRAINT `fk_app_candidate` FOREIGN KEY (candidate_user_id) REFERENCES users (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE applications ADD CONSTRAINT `fk_app_job` FOREIGN KEY (job_id) REFERENCES jobs (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE applications ADD CONSTRAINT `fk_app_resume` FOREIGN KEY (resume_id) REFERENCES resumes (id) ON UPDATE CASCADE');
        ...
        $this->addSql('DROP INDEX idx_match_score ON match_results');
        $this->addSql('ALTER TABLE match_results ADD engine_name VARCHAR(100) NOT NULL, ADD decision VARCHAR(50) NOT NULL, ADD overall_score INT NOT NULL, ADD raw_payload JSON DEFAULT NULL, ADD created_at DATETIME NOT NULL, DROP algorithm_version, DROP match_score, DROP notes, DROP computed_at, CHANGE matched_keywords scores JSON DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jobs DROP FOREIGN KEY FK_A8936DC5979B1AD6');
        $this->addSql('ALTER TABLE jobs DROP FOREIGN KEY FK_A8936DC512CA0262');
        $this->addSql('ALTER TABLE jobs ADD image_name VARCHAR(255) DEFAULT NULL, CHANGE work_mode work_mode ENUM(\'ONSITE\', \'HYBRID\', \'REMOTE\') DEFAULT \'ONSITE\' NOT NULL, CHANGE employment_type employment_type ENUM(\'FULL_TIME\', \'PART_TIME\', \'CONTRACT\', \'INTERN\', \'TEMP\') DEFAULT \'FULL_TIME\' NOT NULL, CHANGE status status ENUM(\'DRAFT\', \'PUBLISHED\', \'CLOSED\') DEFAULT \'DRAFT\' NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE jobs ADD CONSTRAINT `fk_jobs_company` FOREIGN KEY (company_id) REFERENCES companies (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE jobs ADD CONSTRAINT `fk_jobs_posted_by` FOREIGN KEY (posted_by_user_id) REFERENCES users (id) ON UPDATE CASCADE');
        ...
        $this->addSql('ALTER TABLE match_results ADD algorithm_version VARCHAR(50) DEFAULT \'v1\' NOT NULL, ADD match_score NUMERIC(5, 2) NOT NULL, ADD matched_keywords JSON DEFAULT NULL, ADD notes TEXT DEFAULT NULL, ADD computed_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, DROP engine_name, DROP decision, DROP overall_score, DROP scores, DROP raw_payload, DROP created_at');
        $this->addSql('ALTER TABLE match_results ADD CONSTRAINT `fk_match_application` FOREIGN KEY (application_id) REFERENCES applications (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('CREATE UNIQUE INDEX uq_match_app_algo ON match_results (application_id, algorithm_version)');
        $this->addSql('CREATE INDEX idx_match_score ON match_results (match_score)');
